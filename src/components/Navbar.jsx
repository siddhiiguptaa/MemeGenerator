    ...
    return (
        <nav className="navbar  bg-black text-white flex justify-between rounded-full border-1 border-black border-opacity-70 items-center px-10 py-2 shadow-md sticky top-0 z-10">
            ...
            <ul className="nav-links list-none flex">
                ...
                <button className="goback border-none rounded-10 w-16 h-6 items-center justify-center cursor-pointer" onClick={()=>navigate(-1)}>goBack</button>
                <a href="https://github.com/siddhiiguptaa/MemeGenerator" target="_blank" rel="noopener noreferrer">
                <svg style={{ color: "white", marginTop:"-6px" }} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
